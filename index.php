      ...
      <div class="content">
          <div class="starter-template">
            ...
            <div class="jumbotron">
              ...
              $iconnum=$_SESSION['iconid'];
              $iconpre="public/img/enemies/icon (";
              $iconsuf=").png";
              echo "<p>
              <img src='$iconpre$iconnum$iconsuf'/>
              </p>";
              ...
              <label for="file">如果您想使用自己的图片，请上传（格式为PNG，大小请小于150KB.）:</label>
              ...
              <li><a role="button" href="display.php" >查看所有人的成绩</a></li>
